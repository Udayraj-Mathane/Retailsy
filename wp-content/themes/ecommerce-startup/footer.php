...
?>
	<footer id="colophon" class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
        ...
        $ecommerce_startup_newsletter =  best_shop_get_setting('subscription_shortcode');
        
        if( $active_sidebars && $sidebar_count > 0 ||  $ecommerce_startup_newsletter !=='' ){ ?>
            <div class="footer-top">
                <div class="container"><?php

                    if($ecommerce_startup_newsletter) {
                        ?>
                        <div class="footer-newsletter-section">
                        <?php
                        the_widget('best_shop_newsletter_widget', array('newsletter_shortcode'=> $ecommerce_startup_newsletter ));
                        ?>
                        </div>
                        <?php
