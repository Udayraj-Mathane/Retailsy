...
if(best_shop_get_setting( 'timer_message' ) && is_home() && class_exists("best_shop_countdown_timer_widget")) { ?>
<div class="container timer_container"><div class="row timer_row"><div class="col-md-6"><?php echo esc_html(best_shop_get_setting( 'timer_message' )); ?></div><div class="col-md-6"><?php the_widget('best_shop_countdown_timer_widget', array('to_year'=>best_shop_get_setting('timer_year'), 'to_date'=>best_shop_get_setting( 'timer_date' ), 'text_to_show'=>best_shop_get_setting( 'timer_message' ), 'to_month'=>best_shop_get_setting( 'timer_month' ) , 'show_labels'=>'true') ); ?></div></div></div>
<?php } ?>
